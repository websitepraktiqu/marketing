            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                ...
                <div className="space-y-8 text-center lg:text-left">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg mx-auto lg:mx-0">
                        ...
                        <div className="flex items-center gap-4 p-4 rounded-xl bg-white border border-slate-100 shadow-sm hover:shadow-md transition-shadow sm:col-span-2 lg:col-span-1">
                            ...
                            <div className="text-left">
                                <h3 className="font-bold text-slate-900 text-sm">Rekaman Zoom</h3>
                                <p className="text-slate-500 text-xs">Akses Seumur Hidup</p>
                            </div>
                        </div>
                    </div>
                </div>

                ...
                {isMenuOpen && (
                    <div className="md:hidden py-4 border-t border-slate-100">
                        <div className="flex flex-col gap-4">
                            <Link href="#materi" className="text-slate-600 hover:text-[#435b9b] font-medium">Materi</Link>
                            <Link href="#expert" className="text-slate-600 hover:text-[#435b9b] font-medium">Expert</Link>
                            <Link href="#investasi" className="text-slate-600 hover:text-[#435b9b] font-medium">Investasi</Link>
                            <Link href="#faq" className="text-slate-600 hover:text-[#435b9b] font-medium">FAQ</Link>
                            <Link
                                href="#investasi"
